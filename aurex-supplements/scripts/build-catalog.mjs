...
const GROUPS = [
  ...
  ['amino-acids', 'Amino Acids', ['Amino acids','Bcaa','Eaa','Glutamine','Amino acid pills','Amino Acid Complex Powder','Arginine','L-citrulline','Beta Alanine','Hmb']],
  ['mass-gainers', 'Mass Gainers', ['Mass gainers','Carbs','Carbs complex powder','Cream Of Rice']],
  ['vitamins', 'Vitamins & Health', ['Vitamins','Multi Vitamin','Minerals','Vitamin B','Vitamin C','Vitamin D','Vitamin E','Magnesium','Zinc','Calcium','Selenium','Fish Oil','Coq10','Biotin','Chromium','boron','Electrolytes','Fibers','Digestive Enzymes','Liver Support','kidney support','Joint Support','Glucosamine','Melatonin','L-Theanine','5-HTP','Inositol','Ashwagandha','Lions mane','Astragalus','mct oil','Moringa','matcha','Dandelion','Apple Cider Vinegar','Berberine']],
